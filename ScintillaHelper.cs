...
namespace BulkDeleteManager
{
    ...
    {
        public static void ConfigureForXml(this Scintilla scintilla)
        {
            ...
            scintilla.Styles[Style.Xml.Comment].ForeColor = Color.Gray;
        ...
        public static void FormatXML(this Scintilla scintilla)
        {
